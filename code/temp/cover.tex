\documentclass{article}
    ...
    GPS Coordinates: -24.0574$^{\circ}$ S, -47.4455$^{\circ}$ W    \\
    PPA Irregular Area: 161.09 $ha$  \\
    River Area: 412.43 $ha$              \\
    Vegetation Area: 13.39 $ha$           \\
    Non Vegetation: 0 $ha$           \\
    Total Area: 586.91 $ha$              \\
    Cost \$~/~$ha$: 10000               \\
    \rule{\linewidth}{1pt}
    \textbf{Estimated Cost:} \$ 1610900.0           \\
    \rule{\linewidth}{1pt}

    \end{minipage}\hfil
    \begin{minipage}{0.5\linewidth}
        \includegraphics[width=\linewidth]{C:/Users/Artur Oliveira/projetosdev/rivereye/code/temp/map1.jpg}
    \end{minipage}
    ...
    GPS Coordinates: -24.0589$^{\circ}$ S, -47.4082$^{\circ}$ W    \\
    PPA Irregular Area: 66.83 $ha$  \\
    River Area: 165.41 $ha$              \\
    Vegetation Area: 0.73 $ha$           \\
    Non Vegetation: 0 $ha$           \\
    Total Area: 232.97 $ha$              \\
    Cost \$~/~$ha$: 10000               \\
    \rule{\linewidth}{1pt}
    ...
    \end{minipage}\hfil
    \begin{minipage}{0.5\linewidth}
        \includegraphics[width=\linewidth]{C:/Users/Artur Oliveira/projetosdev/rivereye/code/temp/map2.jpg}
    \end{minipage}
